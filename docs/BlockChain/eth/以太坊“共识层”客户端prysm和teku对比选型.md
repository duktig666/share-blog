...
>
> ![img](https://typecho-1300745270.cos.ap-shanghai.myqcloud.com/typora/3d8bf823632ad5471a224c95056609d7.png)
>
> - Prysm: 2.0.6
> - Teku: 22.3.2
...
![img](https://typecho-1300745270.cos.ap-shanghai.myqcloud.com/typora/7303d4eed0d9be909f4e5adc2a7e1748.png)
...
![img](https://typecho-1300745270.cos.ap-shanghai.myqcloud.com/typora/e194040a4a35363ea9999f8ff4ee0f68.png)
...
![img](https://typecho-1300745270.cos.ap-shanghai.myqcloud.com/typora/1b16c5e5903aec67502070e552cc2f60.png)

##### 磁盘写入

Prysm，在同步过程开始时，每秒的磁盘写入操作次数较多，这一数字逐渐减少，直到Altair之后趋于平稳。

![img](https://typecho-1300745270.cos.ap-shanghai.myqcloud.com/typora/0306929d923ab6a4b7d5c6ad9604a73e.png)

> 这可以解释为，在Beacon链的初期，验证者的数量远低于今天，而这些时段的时隙处理速度要快得多。这两个数字是相关的，正如我们在 图磁盘占用 中所看到的，随着网络中验证者和证明数量的增加，磁盘使用量的增长在前半段相当低，在后半段则加速。

##### 磁盘读取

![img](https://typecho-1300745270.cos.ap-shanghai.myqcloud.com/typora/f409d472534cdad4e738f08b65104d8b.png)
...
![img](https://typecho-1300745270.cos.ap-shanghai.myqcloud.com/typora/aaa334e66698331de73a040d1b925a9c.png)

#### 网络带宽利用率

Teku占用比所有客户端更多的带宽，当启用all-topics选项时，这一点尤其明显。我们已经与Teku团队分享了这些发现，他们正在调查这种高网络活动。Teku团队报告称，自v22.5.1更新以来，CPU减少了25%，输出带宽减少了38%。

![img](https://typecho-1300745270.cos.ap-shanghai.myqcloud.com/typora/c20504b773240b45f084a7bbc5da08c5.png)
...
![image-20220627105751911](https://typecho-1300745270.cos.ap-shanghai.myqcloud.com/typora/image-20220627105751911.png)

![image-20220627105823553](https://typecho-1300745270.cos.ap-shanghai.myqcloud.com/typora/image-20220627105823553.png)
...
![image-20220627110209460](https://typecho-1300745270.cos.ap-shanghai.myqcloud.com/typora/image-20220627110209460.png)
